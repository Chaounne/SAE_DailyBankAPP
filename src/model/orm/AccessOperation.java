...
public class AccessOperation {
	 ...
	 *
	 * Exactement la meme procedure que un debit sauf:
	 *  - On prend pas en compte le découvert
	 *	- C'est un débit, mais négaitf
