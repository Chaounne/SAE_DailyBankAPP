...
/**
 * @author Enzo
 * Fenêtre principale afficher au démarrage de l'application
 */
public class DailyBankMainFrame extends Application {
	...
	public void start(Stage primaryStage) throws DataAccessException {
		...
		ap.executerPrelevAuto();
		System.out.println(ap.isPrelevedToday());
	...
	/**
	 * Déconnection de utilisateur connecté
	 */
	...
	/**
	 * Connection de l'utilisateur a son compte
	 */
	public void login() {
	...
	/**
	 * Page des gestion des clients de la meme agence que la personne connecté
	 */
	...
	/**
	 * Page de gestion des employés de la même agence que la personne connecté
	 */
