...
public class OperationsManagementController implements Initializable {
	...
	@FXML
	private void doPrint() throws FileNotFoundException, DocumentException {
		try {
			this.om.imprimer();
		} catch (FileNotFoundException | DataAccessException | DatabaseConnexionException | DocumentException e) {
